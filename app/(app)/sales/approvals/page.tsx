...
export default async function SalesApprovalsPage() {
  ...
  const profile = await getCurrentInternalUser(supabase, "/sales/approvals");
  const canReview = hasAnyRole(profile, ["Admin", "Sales Head"]);
