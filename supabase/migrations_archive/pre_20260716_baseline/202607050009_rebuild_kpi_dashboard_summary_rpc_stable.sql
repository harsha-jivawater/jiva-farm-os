  ...
  return (
    ...
    select jsonb_build_object(
      ...
      'management', jsonb_build_object(
        ...
        'activeDealers', (select count(*) from matched_dealers where dealer_status_text = 'Active Dealer'),
      ...
      'dealers', jsonb_build_object(
        ...
        'activeDealers', (select count(*) from matched_dealers where dealer_status_text = 'Active Dealer'),
        'dormantDealers', (select count(*) from matched_dealers where dealer_status_text = 'Dormant Dealer'),
